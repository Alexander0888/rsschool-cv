  ...
  (() => {
    ...
    r.VantaBase = class {
      constructor(e = {}) {
        ...
        if (
          ((this.options = Object.assign(
            { mouseControls: !0, touchControls: !0, gyroControls: !1, minHeight: 200, minWidth: 200, scale: 1, scaleMobile: 1 },
            t
          )),
        ...
        try {
          ...
          return (
            ...
            void (
              ...
              (this.el.style.background = ((n = this.options.backgroundColor), "number" == typeof n ? "#" + ("00000" + n.toString(16)).slice(-6) : n)))
            )
          );
        }
      ...
      resize() {
        this.setSize(),
          this.camera &&
            ((this.camera.aspect = this.width / this.height), "function" == typeof this.camera.updateProjectionMatrix && this.camera.updateProjectionMatrix()),
      ...
      animationLoop() {
        ...
        return (
          ...
          (this.isOnScreen() || this.options.forceAnimate) &&
            ...
            this.scene &&
              this.camera &&
              (this.renderer.render(this.scene, this.camera), this.renderer.setClearColor(this.options.backgroundColor, this.options.backgroundAlpha)),
    ...
    const x = function (e, t, i, n) {
      ...
      function T(e, t) {
        var i = new w({ uniforms: (t = t || {}), vertexShader: "void main()\t{\n\n\tgl_Position = vec4( position, 1.0 );\n\n}\n", fragmentShader: e });
        return x(i), i;
      }
      s.add(h),
      ...
      constructor(e) {
        ...
        (this.position = new T.Vector3()),
          ...
          (this.flock = function (e) {
            i && t.add(this.reach(i, 0.005)), t.add(this.alignment(e)), t.add(this.cohesion(e)), t.add(this.separation(e));
          }),
          (this.move = function () {
            this.velocity.add(t);
          ...
          (this.repulse = function (e) {
            ...
            if (i < 150) {
              var n = new T.Vector3();
              n.subVectors(this.position, e), n.multiplyScalar(0.5 / i), t.add(n);
            }
          }),
          ...
          (this.alignment = function (e) {
            ...
            for (var r = 0, h = e.length; r < h; r++)
              Math.random() > 0.6 || ((i = (t = e[r]).position.distanceTo(this.position)) > 0 && i <= s && (n.add(t.velocity), o++));
            if (o > 0) {
              n.divideScalar(o);
              var c = n.length();
          ...
          (this.cohesion = function (e) {
            ...
            for (var h = 0, c = e.length; h < c; h++)
              Math.random() > 0.6 || ((i = (t = e[h]).position.distanceTo(this.position)) > 0 && i <= r && (n.add(t.position), s++));
            ...
            for (var r = 0, a = e.length; r < a; r++)
              Math.random() > 0.6 ||
                ((i = (t = e[r]).position.distanceTo(this.position)) > 0 &&
                  i <= s &&
                  (o.subVectors(this.position, t.position), o.normalize(), o.divideScalar(i), n.add(o)));
            return n;
          });
      }
    }
    class E extends l {
        ...
        if (M)
          ...
          for (var s = 0; s < l; s++) {
            ...
            c.setAttribute("color", u),
              (o = e[s] = new T.Mesh(c, new T.MeshBasicMaterial({ color: 16777215, side: T.DoubleSide, vertexColors: T.VertexColors }))),
      ...
      onMouseMove(e, t) {
        if (((this.mouseX = e - 0.5), (this.mouseY = t - 0.5), !M)) {
          const e = this.boids;
          let t;
          for (var i = new T.Vector3(this.mouseX * this.width, -this.mouseY * this.height, 0), n = 0, o = e.length; n < o; n++)
